...
export const savePromptToStorage = (
  ...
  try {
    const payload: StoredPromptData = {
      message,
...
export const PromptInputImagePreview = ({
  ...
  return (
    <InputGroupAddon
      align="block-start"
      className={cn("overflow-hidden border-none bg-transparent", className)}
    >
        ...
        {attachments.map((attachment) => (
          ...
          >
            ...
            {onRemove && (
              <Button
                aria-label="Remove attachment"
                className="-right-1.5 -top-1.5 absolute h-6 w-6 rounded-full opacity-0 transition-opacity group-hover:opacity-100"
...
export type PromptInputMicButtonProps = PromptInputSpeechButtonProps;
export const PromptInputMicButton = PromptInputSpeechButton;
